...
// Searchbar animation
var searchExamples = ['Want some suggestions?', 'Chicago', 'San Francisco', 'Austin', 'New York', 'Nashville', 'Atlanta', 'Portland', 'Denver', 'Raleigh', 'Detroit', 'San Diego',];
setInterval(function () {
    $("input#js-search-bar").attr("placeholder", searchExamples[searchExamples.push(searchExamples.shift()) - 1]);
}, 3000);
